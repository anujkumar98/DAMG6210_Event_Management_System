...
BEGIN
    ...
    IF v_user_count > 0 THEN
        ...
        EXECUTE IMMEDIATE 'GRANT ALL ON ATTENDEE_AUDIT TO EVENT_APP_ADMIN';
        ...
        EXECUTE IMMEDIATE 'GRANT EXECUTE ON PKG_APP_ADMIN TO EVENT_APP_ADMIN';
    ...
    IF v_user_count > 0 THEN
        ...
        EXECUTE IMMEDIATE 'GRANT EXECUTE ON PKG_EVENT_MANAGER TO EVENT_MANAGER';
        EXECUTE IMMEDIATE 'GRANT EXECUTE ON GetEventAttendees TO EVENT_MANAGER';
    ...
    IF v_user_count > 0 THEN
        ...
        EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, DELETE, UPDATE ON ATTENDEE TO ATTENDEE;';
        EXECUTE IMMEDIATE 'GRANT SELECT ON EVENTS TO ATTENDEE';
        EXECUTE IMMEDIATE 'GRANT SELECT ON TICKET TO ATTENDEE';
        EXECUTE IMMEDIATE 'GRANT EXECUTE ON PKG_ATTENDEE TO ATTENDEE';
        EXECUTE IMMEDIATE 'GRANT EXECUTE ON GetEventsInTimeRange TO ATTENDEE';
        EXECUTE IMMEDIATE 'GRANT EXECUTE ON GetEventsInCategory TO ATTENDEE';
